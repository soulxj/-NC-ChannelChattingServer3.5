...
public class ChatChannels {
    ...
    static {
        ...
        if (Config.LANG_CHAT == 1) {
            ...
            // JOB
            // Male
            addJobChannel(Gender.MALE, PlayerClass.GLADIATOR, "job_剑星");
            addJobChannel(Gender.MALE, PlayerClass.TEMPLAR, "job_守护星");
            addJobChannel(Gender.MALE, PlayerClass.SORCERER, "job_魔道星");
            addJobChannel(Gender.MALE, PlayerClass.SPIRIT_MASTER, "job_精灵星");
            addJobChannel(Gender.MALE, PlayerClass.CHANTER, "job_护法星");
            ...
            addJobChannel(Gender.FEMALE, PlayerClass.TEMPLAR, "job_守护星");
            addJobChannel(Gender.FEMALE, PlayerClass.SORCERER, "job_魔道星");
            addJobChannel(Gender.FEMALE, PlayerClass.SPIRIT_MASTER, "job_精灵星");
            addJobChannel(Gender.FEMALE, PlayerClass.CHANTER, "job_护法星");
